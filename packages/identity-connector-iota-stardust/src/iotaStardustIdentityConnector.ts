 ...
 */
export class IotaStardustIdentityConnector implements IIdentityConnector {
	/**
	 ...
	 */
	public readonly CLASS_NAME: string = nameof<IotaStardustIdentityConnector>();
	 ...
	 */
	constructor(options: IIotaStardustIdentityConnectorConstructorOptions) {
		Guards.object(this.CLASS_NAME, nameof(options), options);
		Guards.object<IIotaStardustIdentityConnectorConfig>(
			this.CLASS_NAME,
			nameof(options.config),
			options.config
		);
		Guards.object<IIotaStardustIdentityConnectorConfig["clientOptions"]>(
			this.CLASS_NAME,
	...
	private async updateDocument(
		...
		const addresses = await IotaStardust.getAddresses(
			this._config,
