# Class: IotaRebasedIdentityConnector
...
> **new IotaRebasedIdentityConnector**(`options`): [`IotaRebasedIdentityConnector`](IotaRebasedIdentityConnector.md)
...
[`IIotaRebasedIdentityConnectorConstructorOptions`](../interfaces/IIotaRebasedIdentityConnectorConstructorOptions.md)

The options for the identity connector.

#### Returns

[`IotaRebasedIdentityConnector`](IotaRebasedIdentityConnector.md)
