...
import type { IIdentityVerifiableCredentialApplication } from "./contract/IIdentityVerifiableCredentialApplication";
import type { VerifiableCredentialState } from "./contract/verifiableCredentialState";

/**
 * Interface describing a contract which provides identity operations.
 */
export interface IIdentityContract extends IService {
	/**
